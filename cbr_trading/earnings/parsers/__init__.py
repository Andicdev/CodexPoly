...
from cbr_trading.earnings.parsers.july_31_sec import (
...
def earnings_parser_registry() -> dict[str, object]:
    return {
        ...
        "ARES": AresAfterTaxRealizedIncomePerShareParser(),
        "ARCC": AresCapitalCoreEpsParser(),
        "BA": BoeingCoreEpsParser(),
        "BBBY": BedBathBeyondNonGaapEpsParser(),
        "CBRE": CbreGaapEpsParser(),
        "CBOE": CboeAdjustedDilutedEpsParser(),
        "CI": CignaAdjustedIncomePerShareParser(),
        "CL": ColgateBaseBusinessDilutedEpsParser(),
        "CSGP": CostarGaapEpsParser(),
        "CZR": CaesarsGaapEpsParser(),
        "DLB": DolbyNonGaapDilutedEpsParser(),
        "BEN": FranklinAdjustedDilutedEpsParser(),
        "CVX": ChevronAdjustedDilutedEpsParser(),
        "XOM": ExxonEarningsExcludingItemsEpsParser(),
        ...
        "MRNA": ModernaGaapBasicAndDilutedEpsParser(),
