-- Add only the reviewed July 29 MSFT POST_MARKET event. The profile remains
...
BEGIN
    IF now() >= TIMESTAMPTZ '2026-07-29 17:45:00+00' THEN
        RAISE EXCEPTION 'MSFT profile preparation deadline has passed';
    END IF;
...
VALUES (
    ...
    '{
        ...
        "company_ir": {
            ...
            "feed_url": "https://news.microsoft.com/source/tag/investor-relations/feed/",
            "kind": "rss",
            "provider": "company_ir",
            "title_all": [
                "Microsoft",
...
VALUES (
    ...
    'earnings:MSFT:2026Q4',
    'earnings_resolution',
    'https://polymarket.com/event/msft-quarterly-earnings-gaap-eps-07-29-2026-4pt21',
    'abccbaq',
    '0xa7a5a986a14d3c5b47b9892c6aefc48a85ff3e8e02d999ff7dd015f735ad38d8',
    0.999,
    0.999,
    ...
    '{
        ...
        "rule_key": "msft-2026q4-gaap-eps-4pt21",
        "ticker": "MSFT",
...
VALUES (
    ...
    'Reviewed MSFT GAAP diluted EPS parser and disabled profile.',
    now()
)
...
VALUES (
    ...
    TIMESTAMPTZ '2026-07-30 02:00:00+00',
    '{
        "seed": "022_add_msft_july_29_postmarket",
...
BEGIN
    IF (
        ...
        RAISE EXCEPTION 'MSFT rule verification failed';
    END IF;
    ...
    IF (
        ...
        RAISE EXCEPTION 'MSFT profile verification failed';
    END IF;
    ...
    IF (
        ...
        RAISE EXCEPTION 'MSFT schedule verification failed';
    END IF;
    ...
    IF EXISTS (
        ...
        RAISE EXCEPTION 'MSFT execution claim must not exist';
    END IF;
END
$verify$;
