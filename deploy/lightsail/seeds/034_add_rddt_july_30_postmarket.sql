-- Add the issuer-confirmed July 30 RDDT POST_MARKET event. The profile
...
DO $guard$
BEGIN
    IF now() >= TIMESTAMPTZ '2026-07-30 17:53:00+00' THEN
        RAISE EXCEPTION 'RDDT profile preparation deadline has passed';
    END IF;
    IF EXISTS (
...
VALUES (
    ...
    2,
    'USD',
    'rddt-quarterly-earnings-gaap-eps-07-30-2026-0pt97',
    '0x6af77208e2962fa9ad5e2b12047d39d0bd9cfc13a5557621f61b1331638be25f',
    '{
        ...
        "company_ir": {
            "allowed_document_hosts": ["investor.redditinc.com"],
            "feed_url": "https://investor.redditinc.com/news-events/news-releases/default.aspx",
            "kind": "html_listing",
            "listing_utc_offset_minutes": -240,
            "provider": "company_ir",
            "title_all": ["Reddit", "Second Quarter", "2026", "Results"],
...
VALUES (
    ...
    'earnings:RDDT:2026Q2',
    'earnings_resolution',
    'https://polymarket.com/event/rddt-quarterly-earnings-gaap-eps-07-30-2026-0pt97',
    'abccbaq',
    '0x6af77208e2962fa9ad5e2b12047d39d0bd9cfc13a5557621f61b1331638be25f',
    0.999,
    0.999,
    ...
    '{
        ...
        "block_id": "2026-07-30-rddt-post-market"
    }'::jsonb,
    'DISABLED'
)
...
VALUES (
    ...
    'HIGH',
    7200,
    'https://www.sec.gov/Archives/edgar/data/1713445/000171344526000067/0001713445-26-000067-index.htm',
    'CONFIRMED',
    ...
    (
        ...
        'Q1 2026 and Q3 2025 SEC filings were both accepted near 16:08:35 ET.'
    ),
    now()
)
...
VALUES (
    ...
    'earnings-rddt-2026q2',
    'AUTO_PREFLIGHT',
    TIMESTAMPTZ '2026-07-30 17:53:00+00',
    TIMESTAMPTZ '2026-07-30 18:08:00+00',
    TIMESTAMPTZ '2026-07-31 02:00:00+00',
    TIMESTAMPTZ '2026-07-30 20:08:00+00',
    7200,
    ...
    1,
    '{
        "seed": "034_add_rddt_july_30_postmarket",
        ...
        "earliest_signal_at": "2026-07-30T20:08:00Z",
...
BEGIN
    IF (
        ...
        RAISE EXCEPTION 'RDDT rule verification failed';
    END IF;
    IF (
        ...
        RAISE EXCEPTION 'RDDT profile verification failed';
    END IF;
    IF (
        ...
        RAISE EXCEPTION 'RDDT schedule verification failed';
    END IF;
